---- 유저
INSERT INTO users(user_id, user_name, user_email, user_phone, created_at, updated_at)
VALUES (1, "kim", "kim@email.com", "01011111111", now(), now()),
       (2, "lee", "lee@email.com", "01022222222", now(), now()),
       (3, "ryu", "ryu@email.com", "01033333333", now(), now());

---- 그룹
INSERT INTO team(group_id, group_name, manager_id, created_at, updated_at)
VALUES (1, "kim's group", 1, now(), now()),
       (2, "lee's group", 2, now(), now()),
       (3, "ryu's group", 3, now(), now());
